...
function ResetPawn(victim) {
  ...
  switch (victim) {
    case 'redpawn1':
      pawnToMove.style.top = 194 + 'px';
      pawnToMove.style.left = 523 + 'px';
      break;
    case 'redpawn2':
      pawnToMove.style.top = 194 + 'px';
      pawnToMove.style.left = 580 + 'px';
      break;
    case 'redpawn3':
      pawnToMove.style.top = 137 + 'px';
      pawnToMove.style.left = 523 + 'px';
      break;
    case 'redpawn4':
      pawnToMove.style.top = 137 + 'px';
      ...
      break;
    case 'bluepawn1':
      pawnToMove.style.top = 528 + 'px';
      pawnToMove.style.left = 509 + 'px';
      break;
    case 'bluepawn2':
      pawnToMove.style.top = 528 + 'px';
      pawnToMove.style.left = 573 + 'px';
      break;
    case 'bluepawn3':
      pawnToMove.style.top = 585 + 'px';
      pawnToMove.style.left = 509 + 'px';
      break;
    case 'bluepawn4':
      pawnToMove.style.top = 585 + 'px';
    ...
    case 'greenpawn1':
      pawnToMove.style.top = 194 + 'px';
      pawnToMove.style.left = 118 + 'px';
      break;
    case 'greenpawn2':
      pawnToMove.style.top = 194 + 'px';
      pawnToMove.style.left = 175 + 'px';
      break;
    case 'greenpawn3':
      pawnToMove.style.top = 137 + 'px';
      pawnToMove.style.left = 175 + 'px';
      break;
    case 'greenpawn4':
      pawnToMove.style.top = 136 + 'px';
      pawnToMove.style.left = 118 + 'px';
      break;
    case 'yellowpawn1':
      pawnToMove.style.top = 521 + 'px';
      pawnToMove.style.left = 125 + 'px';
      break;
    case 'yellowpawn2':
      pawnToMove.style.top = 585 + 'px';
      pawnToMove.style.left = 125 + 'px';
